...
namespace SFC.GeneralTemplate.Infrastructure.Consumers.GeneralTemplate.Data.Data;
...
public class RequireDataConsumerDefinition : ConsumerDefinition<InitializeDataConsumer>
{
    ...
    private Exchange Exchange { get { return _settings.Exchanges.GeneralTemplate.Value.Data.Dependent.Data.Initialize; } }

    public RequireDataConsumerDefinition(IConfiguration configuration)
    {
        _settings = configuration.GetRabbitMqSettings();
        EndpointName = "sfc.generaltemplate.data.data.initialize.queue";
    }
